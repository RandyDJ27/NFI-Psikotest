...
<body onload="window.print()">
    ...
    <div class="container">
        ...
        <h3 class="text-right">DAFTAR PESERTA LULUS TES PSIKOTES</h3>
...
$tampil = mysqli_query($koneksi, "SELECT nama,jk,email,benar,salah,kosong,score,keterangan FROM tbl_user INNER JOIN tbl_nilai ON tbl_user.id_user=tbl_nilai.id_user WHERE keterangan='Lulus'");
echo"
